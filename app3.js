// app3.js
// Parte 2: Gestión de rendimientos y rentabilidad
...
const renderizarTodo_original2 = renderizarTodo;
renderizarTodo = function() {
  renderizarTodo_original2();
...
document.querySelectorAll('[data-accion="nuevo-rendimiento"]').forEach(item => {
  ...
  // Eliminar listeners anteriores si ya existen (evitar duplicados)
